import 'package:code0/tutorial/overlay2.dart';
...
import '../pages/home/news/services/api_service.dart';

class Overlay1 extends StatefulWidget {
  const Overlay1({super.key});

  @override
  State<Overlay1> createState() => _Overlay1State();
}

class _Overlay1State extends State<Overlay1> {
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const Overlay2(),
                            ),
                          );
                        },
                        child: Image.asset(
