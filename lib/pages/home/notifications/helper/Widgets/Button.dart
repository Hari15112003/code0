...
class _ButtonState extends State<Button> {
  ...
  Widget txtWidget() {
    dynamic finalText;
    if (processing) finalText = widget.processingText;
    if (processed) finalText = widget.ontaskCompletedText;
  ...
  Widget iconWidget() {
    ...
    if (icon is IconData) child = Icon(icon, color: _textColor, size: widget.fontSize);
